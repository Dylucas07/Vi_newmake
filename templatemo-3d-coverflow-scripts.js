        ...
        const imageData = [
            {
                ...
                description: "Aqui, cada detalhe é pensado para realçar a sua beleza única."
            },
            {
                title: "VL - Beauty Studio",
                description: "Transformamos momentos em magia, e sua beleza é o ponto de partida"
            },
            {
                title: "VL - Beauty Studio",
                description: "Mais que maquiagem: uma experiência de autoestima e encantamento."
            },
            {
                title: "VL - Beauty Studio",
                description: "Cada produção é feita com carinho, técnica e um olhar atento à sua essência."
            },
            {
                title: "VL - Beauty Studio",
            ...
            {
                title: "VL - Beauty Studio",
                description: "Você merece um momento só seu, com atenção, respeito e delicadeza."
            },
            {
                title: "VL - Beauty Studio",
                description: "Cuidar de você é nossa prioridade — por dentro e por fora."
            }
        ];
